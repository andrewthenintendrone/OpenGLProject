...
int main()
{
	...
	// -------------------------
	Shader ourShader((fs::current_path().string() + "\\resources\\shaders\\specular.vs").c_str(), (fs::current_path().string() + "\\resources\\shaders\\specular.fs").c_str());
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// set shader material
		ourShader.setVec3("material.color", glm::vec3(0.5));
		ourShader.setFloat("material.ambient", 0.1f);
		ourShader.setFloat("material.diffuse", 1.0f);
		ourShader.setFloat("material.specular", 0.2f);
