...
Color Color::Splatoon2Lemon()
{
	return Color(0xBBC905FF);
}

Color Color::Splatoon2Plum()
{
	return Color(0x830B9CFF);
}

Color Color::Splatoon2Sky()
{
	return Color(0x007EDCFF);
}

Color Color::Splatoon2Gold()
{
	return Color(0xE1A307FF);
}

Color Color::Splatoon2LightPink()
{
	return Color(0xD60E6EFF);
}

Color Color::Splatoon2Blue()
{
	return Color(0x311AA8FF);
}

Color Color::Splatoon2NeonPink()
{
	return Color(0xCF0466FF);
}

Color Color::Splatoon2NeonGreen()
{
	return Color(0x17A80DFF);
}

Color Color::Splatoon2Pink()
{
	return Color(0xCB0856FF);
}

Color Color::Splatoon2LightBlue()
{
	return Color(0x0199B8FF);
}

Color Color::Splatoon2Raspberry()
{
	return Color(0xDE0B64FF);
}

Color Color::Splatoon2NeonYellow()
{
	return Color(0xBFD002FF);
}

Color Color::Splatoon2DarkPurple()
{
	return Color(0x4A14AAFF);
}

Color Color::Splatoon2Orange()
{
	return Color(0xFB5C03FF);
}

Color Color::Splatoon2Grape()
{
	return Color(0x5F0FB4FF);
}

Color Color::Splatoon2Turquoise()
{
	return Color(0x08B672FF);
}
